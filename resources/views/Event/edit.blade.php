...
@push('css')
  <link href="{{ URL::asset('/css/Event/edit.css') }}" rel="stylesheet" type="text/css" />
...
@section('content')<div class="container">
  <form action="/event/{{$event->id}}/edit" method="post" enctype="multipart/form-data">
    {{ csrf_field()}}
    <!-- Titles -->
    ...
    <div class="row">
      ...
      <div class="col-7">
        <div class="input-group date">
          <input type="text" class="form-control" name="date" value="{{$event->date}}" ><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-7">
        <input type='text' class="form-control time" value="{{$event->time}}" name="time" />
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-7">
        <div class="form-group">
          <select class="form-control" id="sel1" name="zone"  value="{{$event->zone}}" required>
    ...
    <br/>
    <button type="submit" class="btn btn-success w-100 mt-1">Save</button>
  </form>
  <br/>
  <br />
